...
<img width="1862" height="861" alt="image" src="https://github.com/user-attachments/assets/7d1085fa-a4c5-4342-bd0a-e1d168a7f541" />
<img width="1872" height="861" alt="image" src="https://github.com/user-attachments/assets/9a4b893d-ac2c-47f3-9df6-c990ed82dcbd" />
...
<img width="1844" height="859" alt="image" src="https://github.com/user-attachments/assets/8bb2af02-94a1-4cb7-a966-2a2c4331ef88" />
...
```bash
git clone https://github.com/situk0000/individual-quantum-stock-market.git
...
- 🔢 Input OHLC + calculated features (Returns, Volatility, etc.)
- ⚙️ Scale using pre-trained StandardScaler
- 🌀 Encode into quantum states via PennyLane circuits
- 🎯 Match against historical patterns with cosine similarity
...
**Situ Kumari** - [@situk0000](https://github.com/situk0000)
